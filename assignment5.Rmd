...
In 2017, the mean salamander weight at the CC sites was `r round(summary_CC_2017$mean_weight, 2)`, and the mean salamander weight at the OG sites was `r round(summary_OG_2017$mean_weight, 2)`. The mean lobster size between CC sites and OG sites did not differ significantly (t(`r round(weight_2017_ttest$parameter, 2)`) = `r round(weight_2017_ttest$statistic, 2)`, p = (`r round(weight_2017_ttest$p.value, 4)`) with a small effect size of `r round(weight_2017_cohen$estimate, 2)`. 
